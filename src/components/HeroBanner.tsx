...
export default function HeroBanner({phone}: { phone: string }) {
    return (
        <div className="flex items-start flex-col gap-y-4 px-12 lg:px-72 md:px-36 py-8">
            <h1 className="text-6xl lg:text-8xl font-bold text-start py-4 text-primary">Professional Cleaning Services</h1>
            <p className="text-start text-gray-600 text-md md:text-3xl lg:text-4xl">Offering Top-quality cleaning for homes, businesses, NDIS
